...
(function () {
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ? (V(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ma(h._menuButton), sa(h, h._menuButton, "menu")) : wa(h._menuButton);
            ...
            P(
                ...
                function () {
                    n ||
                        (V(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }),
                        0 >= navigator.userAgent.search("MSIE") && V(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                h.allDOMEventHandlers,
                !0
            );
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ha = 0; ha < E.length; ha++)
                V(E[ha], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (E[ha].innerHTML = s[ha]);
        } else
            !h._dropdownMenu &&
                h.exportEnabled &&
                w &&
    ...
    function Na(h, n, E, xa) {
        w && ab
            ? ((xa = !s(xa) && xa ? h.getContext("2d", { willReadFrequently: !0 }) : h.getContext("2d")),
              (Oa = xa.webkitBackingStorePixelRatio || xa.mozBackingStorePixelRatio || xa.msBackingStorePixelRatio || xa.oBackingStorePixelRatio || xa.backingStorePixelRatio || 1),
              (la = Sa / Oa),
              (h.width = n * la),
              (h.height = E * la),
              Sa !== Oa && ((h.style.width = n + "px"), (h.style.height = E + "px"), xa.scale(la, la)))
    ...
    function sa(h, n, s) {
        n.getAttribute("state") ||
            ((n.style.backgroundColor = h.toolbar.itemBackgroundColor), (n.style.color = h.toolbar.fontColor), (n.style.border = "none"), V(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        n.getAttribute("state") !== s &&
            (n.setAttribute("state", s),
            n.setAttribute("type", "button"),
            V(n, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
            (n.innerHTML = "<img src='" + kb[s].image + "' alt='" + h._cultureInfo[s + "Text"] + "' />"),
    ...
    function za(h, n) {
        ...
        if (s(this.options.margin) && h.options.subtitles)
            for (var E = h.options.subtitles, w = 0; w < E.length; w++)
                if (
                    ((s(E[w].horizontalAlign) && "center" === this.horizontalAlign) || E[w].horizontalAlign === this.horizontalAlign) &&
                    ((s(E[w].verticalAlign) && "top" === this.verticalAlign) || E[w].verticalAlign === this.verticalAlign) &&
    ...
    var gb = (function () {
        ...
        da = function (h, n, s) {
            ...
            G && ((n = Math.floor(h)), (J = -Math.floor(Math.log(h) / Math.LN10 + 1)), (Q = 0 === h ? 0 : 0 === n ? -(P + J) : nb(n).length - P), (A /= Math.pow(10, Q)));
            0 > K && (K = M);
            A = (h * A).toFixed(T);
            n = A.split(".");
            A = (n[0] + "").split("");
                ...
                if (((n = N.pop()), "#" === n || "0" === n))
                    ...
                    ("E" !== n[0] && "e" !== n[0]) || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n)
                        ? "," === n
                            ...
                            : (s = 1 < n.length && (('"' === n[0] && '"' === n[n.length - 1]) || ("'" === n[0] && "'" === n[n.length - 1])) ? n.slice(1, n.length - 1) + s : n + s)
                        : ((n = 0 > Q ? n.replace("+", "").replace("-", "") : n.replace("-", "")),
    ...
    G.prototype.updateOption = function (h) {
        ...
        this.theme && s(this.parent) && s(B) && s(J)
            ...
            : this.parent &&
              ...
              (null === J ? (w = this.parent.themeOptions[B]) : 0 < this.parent.themeOptions[B].length && ((w = Math.min(this.parent.themeOptions[B].length - 1, J)), (w = this.parent.themeOptions[B][w])));
        this.themeOptions = w;
    ...
    za.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), (J = 0.5 * n.height - this.margin - 2), (B = 0))
            ...
            N = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((v = n.y1 + 2 + this.fontSize / 2 + 4), (K = "top")) : "bottom" === this.verticalAlign && ((v = n.y2 - 2 - N.height + this.fontSize / 2 + 4), (K = "bottom")),
                  "left" === this.horizontalAlign ? (w = n.x1 + 2) : "center" === this.horizontalAlign ? (w = n.x1 + n.width / 2 - N.width / 2) : "right" === this.horizontalAlign && (w = n.x2 - 2 - N.width - A),
                  (G = this.horizontalAlign),
                  (this.width = N.width),
                  (this.height = N.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = n.x1 + 2 + (this.fontSize / 2 + 4)), (v = n.y2 - 2 - (this.maxWidth / 2 - N.width / 2)), (B = -90), (K = "left"), (this.width = N.height), (this.height = N.width))
                      : "right" === this.horizontalAlign
                      ? ((w = n.x2 - 2 - (this.fontSize / 2 + 4)), (v = n.y1 + 2 + (this.maxWidth / 2 - N.width / 2)), (B = 90), (K = "right"), (this.width = N.height), (this.height = N.width))
                      : "center" === this.horizontalAlign && ((v = h.y1 + (h.height / 2 - N.height / 2) + this.fontSize / 2 + 4), (w = h.x1 + (h.width / 2 - N.width / 2)), (K = "center"), (this.width = N.width), (this.height = N.height)),
                  (G = "center"));
            J.x = w;
            J.y = v;
            J.angle = B;
    ...
    B = Qa.Chart = (function () {
        ...
        n.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    V(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    P(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (V(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                    ...
                    P(
                        ...
                        function () {
                            d ||
                                (V(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                ...
                this._resetButton
                    ? (V(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    : ((d = !1),
                      ...
                      P(
                          ...
                          function () {
                              d ||
                                  (V(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                          },
                          this.allDOMEventHandlers
                      ),
                      P(
                          ...
                          function () {
                              d ||
                                  (V(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                          },
                          this.allDOMEventHandlers
                      ),
        ...
        n.prototype.renderElements = function () {
            if (this.height) {
                ...
                this.animatedRender &&
                    ...
                    c.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
                    ...
                    for (C = 0; C < t.dataPoints.length; C++) {
                        ...
                        if (0 < C) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((r = e / t.dataPoints[C - 1].y), 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r))
                                    : ((r = e - t.dataPoints[C - 1].y), 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)));
                        }
                        if (b < q && !k) null !== e && (p = b);
                        else {
                            if (!k && ((k = !0), 0 < C)) {
                        ...
                        if (b < ba && !g) null !== p.dataPoints[q].y && (h = b);
                            ...
                            null === p.dataPoints[q].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                                  ...
                                  0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (C = Math.min(e, C)))) : t[b] ? (t[b] += e) : ((t[b] = e), (k = Math.max(e, k))));
                        }
                    }
                    a.axisY.scaleBreaks &&
        ...
        n.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ((t.dataPoints[C].x && t.dataPoints[C].x.getTime) || "dateTime" === t.xValueType) f = !0;
                    for (C = 0; C < t.dataPoints.length; C++)
                        "undefined" !== typeof t.dataPoints[C].isCumulativeSum && !0 === t.dataPoints[C].isCumulativeSum
                            ? ((t.dataPointEOs[C].cumulativeSumYStartValue = 0), (t.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum), (t.dataPoints[C].y = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum))
                            : "undefined" !== typeof t.dataPoints[C].isIntermediateSum && !0 === t.dataPoints[C].isIntermediateSum
                            ? ((t.dataPointEOs[C].cumulativeSumYStartValue = p),
                              ...
                              (b = 0))
                            : ((e = "number" !== typeof t.dataPoints[C].y ? 0 : t.dataPoints[C].y),
                    ...
                    for (C = 0; C < t.dataPoints.length; C++)
                        if (
                            ...
                            0 < C &&
                                (a.axisX.logarithmic
                                    ? ((p = b / t.dataPoints[C - 1].x), 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p))
                                    : ((p = b - t.dataPoints[C - 1].x), 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)),
                                null !== e &&
                                    null !== t.dataPoints[C - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = t.dataPointEOs[C].cumulativeSum / t.dataPointEOs[C - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = t.dataPointEOs[C].cumulativeSum - t.dataPointEOs[C - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(b < q) || k)
                        ) {
                            if (!k && ((k = !0), 0 < C)) {
                                C -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < C &&
                                (t.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[C - 1].cumulativeSum),
                                ...
                                for (t = 0; t < h.dataPoints.length; t++)
                                    if (
                                        (b &&
                                            ...
                                            (f = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x),
                                            (q = Math.floor((f - k) / q)),
                                            f < g[q].min && (g[q].min = f),
                                            f > g[q].max && (g[q].max = f)),
                                        c)
                                        ...
                                        else s(f) || ((q = Math.floor((f - m) / n)), f < d[q].min && (d[q].min = f), f > d[q].max && (d[q].max = f));
                                    }
                        }
                }
            }
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, g = b._dataRanges, f, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++)
                                (f = ((d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
                            (b = a(f[t].start, f[t].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new aa(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    l &&
                        ...
                        l && this.zoomEnabled && "none" === this._zoomButton.style.display && (Ma(this._zoomButton, this._resetButton), sa(this, this._zoomButton, "pan"), sa(this, this._resetButton, "reset")));
                }
            }
            this.isDrag = !1;
        ...
        n.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, C = [], k = [], m = [], p = 0; p < this._axes.length; p++)
        ...
        n.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var ba = ma("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    n = s(m.dataPoint.indexLabelLineThickness) ? (s(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness) : m.dataPoint.indexLabelLineThickness,
                ...
                if (null !== H && "" !== H) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== x
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < v
                                  ? ((g = m.point.y + ("horizontal" === z ? r / 2 : 0) - k - t - b), g < e && ((g = "auto" === x ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t), (A = g + k > m.point.y)))
                                  : ((g = m.point.y + r / 2 + t + b), g > f - k && ((g = "auto" === x ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k), (A = g < m.point.y))))
                            : ((e = Math.max(m.bounds.y1, c.y1)),
                              ...
                              (b =
                                  0 <= p.indexOf("range") || "error" === p
                                      ...
                                      : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === z ? t : 0)),
                              0 < v
                        ...
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((x = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"),
                            ...
                            "inside" !== x
                                ? ((e = c.x1),
                                  (f = c.x2),
                                  0 > v
                                      ? ((q = m.point.x - ("horizontal" === z ? C : C - r / 2) - l - b), q < e && ((q = "auto" === x ? Math.max(m.point.x, e) + l : e + l), (A = q + C > m.point.x)))
                                      : ((q = m.point.x + ("horizontal" === z ? 0 : r / 2) + l + b),
                                        q > f - C - l - b && ((q = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === z ? C : C / 2) - l : f - C - l), (A = q < m.point.x))))
                                  ...
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p
                                          ? 0 > v
                                              ...
                                              : Math.min(m.bounds.x2, c.x2) - C / 2 - l + ("horizontal" === z ? 0 : r / 2)
                                          : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : r / 2)),
                                  (q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === z ? C / 2 : 0) : Math.min(m.point.x, b) - C / 2),
                                  (q = Math.max(q, e)));
                    "vertical" === z && (g += k - r / 2);
                    h.x = q;
                    h.y = g;
                    ...
                    n &&
                        ...
                        0 <= p.indexOf("bar") || ("error" === p && m.axisSwapped)
                            ? d.lineTo(q + (0 < m.direction ? -l : C + l) + ("vertical" === z ? -r / 2 : 0), g + ("vertical" === z ? -k / 2 : k / 2 - r / 2) - t)
                            : 0 <= p.indexOf("column") || ("error" === p && !m.axisSwapped)
                            ? d.lineTo(q + C / 2 - ("horizontal" === z ? 0 : r / 2), g + ("vertical" === z ? (g - k < m.point.y ? 0 : -k) + t : (g - r / 2 < m.point.y ? k : 0) - r / 2))
                            ...
                            : d.lineTo(q + C / 2 - ("horizontal" === z ? 0 : r / 2), g + ("vertical" === z ? (g - k < m.point.y ? 0 : -k) : (g + k < m.point.y ? k : 0) - r / 2)),
                        d.stroke());
                }
            }
                        ...
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (((n = m[u].x.getTime ? m[u].x.getTime() : m[u].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || z || s) && (c.stroke(), w && b.stroke()), (z = !0);
                                    ...
                                    this._eventManager.objectMap[H] = { id: H, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: n, y1: x };
                                    s || z
                                        ? (!s && k.connectNullData
                                              ? (c.setLineDash &&
                                    ...
                                    u < m.length - 1 &&
                                        ...
                                        (h = m[u].lineColor || r),
                                        (c.strokeStyle = h),
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(J(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 !== m[u].markerSize && (0 < m[u].markerSize || 0 < k.markerSize)) {
                                        var D = k.getMarkerProperties(u, n, x, c);
                                        f.push(D);
                                        H = X(H);
                                        w && f.push({ x: n, y: x, ctx: b, type: D.type, size: D.size, color: H, borderColor: H, borderThickness: D.borderThickness });
                                    }
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: n, y: x }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                        ...
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (((n = m[u].getTime ? m[u].x.getTime() : m[u].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || z || s) && (c.stroke(), w && b.stroke()), (z = !0);
                                    ...
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: n, y1: x };
                                    s || z
                                        ? (!s && k.connectNullData
                                              ? (c.setLineDash &&
                                                    (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                                              ...
                                              : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))),
                                          (z = s = !1))
                                        : (c.lineTo(n, H), w && b.lineTo(n, H), c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = { x: n, y: x };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                    ...
                                    0 !== m[u].markerSize &&
                                        ...
                                        ((H = k.getMarkerProperties(u, n, x, c)), f.push(H), (D = X(D)), w && f.push({ x: n, y: x, ctx: b, type: H.type, size: H.size, color: D, borderColor: D, borderThickness: H.borderThickness }));
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: m[u], dataSeries: k, point: { x: n, y: x }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                            ...
                            if (((u = m[s].getTime ? m[s].x.getTime() : m[s].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))))
                                if ("number" !== typeof m[s].y)
                                    0 < s &&
                                        !n &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < x.length && (k.options.nullDataLineDashType || !m[s - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                                            : (d(x), (x = []))),
                                        (n = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: s, x1: u, y1: n };
                                    x[x.length] = { x: u, y: n };
                                    s < m.length - 1 &&
                                        (h !== (m[s].lineColor || r) || p !== (m[s].lineDashType || k.lineDashType)) &&
                                        ((h = m[s].lineColor || r),
                                        (x[x.length - 1].newStrokeStyle = h),
                                        b.setLineDash && (m[s].lineDashType ? ((p = m[s].lineDashType), (x[x.length - 1].newLineDashArray = J(p, k.lineThickness))) : ((p = k.lineDashType), (x[x.length - 1].newLineDashArray = g))));
                                    if (0 !== m[s].markerSize && (0 < m[s].markerSize || 0 < k.markerSize)) {
                                        var H = k.getMarkerProperties(s, u, n, b);
                                        l.push(H);
                                        z = X(z);
                                        w && l.push({ x: u, y: n, ctx: e, type: H.type, size: H.size, color: z, borderColor: z, borderThickness: H.borderThickness });
                                    }
                                    (m[s].indexLabel || k.indexLabel || m[s].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: m[s], dataSeries: k, point: { x: u, y: n }, direction: 0 > m[s].y === a.axisY.reversed ? 1 : -1, color: r });
                                    n = !1;
                                }
                    d(x);
                }
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if ((r[f].getTime ? (C = r[f].x.getTime()) : (C = r[f].x), !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: t, x2: s, y2: u };
                                b = X(b);
                                w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? s : l, t, a.axisX.reversed ? l : s, u, b, 0, null, !1, !1, !1, !1);
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                (u[k].indexLabel || s.indexLabel || u[k].indexLabelFormatter || s.indexLabelFormatter) &&
                                    this._indexLabels.push({
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if ((r[f].getTime ? (C = r[f].x.getTime()) : (C = r[f].x), !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: t, x2: l, y2: s };
                                b = X(b);
                                w && Y(this._eventManager.ghostCtx, u, a.axisX.reversed ? s : t, l, a.axisX.reversed ? t : s, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bar",
                                        dataPoint: r[f],
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (C[b] = u[k].y + (C[b] ? C[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = z = a.axisY.convertValueToPixel(C[b]));
                                ...
                                b = X(b);
                                w && Y(this._eventManager.ghostCtx, z, p, m, x, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || s.indexLabel || u[k].indexLabelFormatter || s.indexLabelFormatter) &&
                                    this._indexLabels.push({
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (C[b] = x + (C[b] ? C[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = x = a.axisY.convertValueToPixel(C[b]));
        ...
        n.prototype.renderArea = function (a) {
            ...
            function b() {
                H &&
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (z = x) : 0 > a.axisY.viewportMaximum ? (z = t.y1) : 0 < a.axisY.viewportMinimum && (z = x),
                    f.lineTo(s, z),
                    f.lineTo(H.x, z),
                    f.closePath(),
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var ea = !0; h < r.length; h++)
                            if (((n = r[h].x.getTime ? r[h].x.getTime() : r[h].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ea)))))
                                    ...
                                    d || ea
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = s), (c = u), (s = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (s = d), (u = c), (H = m), (c = g.nullDataLineDashType), f.setLineDash(L)),
                                                f.lineTo(s, u),
                                                w && l.lineTo(s, u))
                                              : (f.beginPath(), f.moveTo(s, u), w && (l.beginPath(), l.moveTo(s, u)), (H = { x: s, y: u })),
                                          (ea = d = !1))
                                        : (f.lineTo(s, u), w && l.lineTo(s, u), 0 == h % 250 && b());
                                    m = { x: s, y: u };
                                    h < r.length - 1 &&
                                        (A !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (A = r[h].lineColor || v),
                                        (f.strokeStyle = A),
                                        f.setLineDash && (r[h].lineDashType ? ((c = r[h].lineDashType), f.setLineDash(J(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(S))));
                                    var $ = g.dataPointIds[h];
                                    this._eventManager.objectMap[$] = { id: $, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: s, y1: u };
                                    0 !== r[h].markerSize &&
                                        (0 < r[h].markerSize || 0 < g.markerSize) &&
                                        ((n = g.getMarkerProperties(h, s, u, f)), C.push(n), ($ = X($)), w && C.push({ x: s, y: u, ctx: l, type: n.type, size: n.size, color: $, borderColor: $, borderThickness: n.borderThickness }));
                                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: s, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: D });
                                }
                        b();
                        W.drawMarkers(C);
                    }
        ...
        n.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (n = s) : 0 > a.axisY.viewportMaximum ? (n = f.y1) : 0 < a.axisY.viewportMinimum && (n = s);
                    u = { x: c[0].x, y: c[0].y };
                            ...
                            if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))))
                                if ("number" !== typeof p[q].y)
                                    0 < q &&
                                        !r &&
                                        (m.connectNullData
                                            ? b.setLineDash && 0 < y.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((y[y.length - 1].newLineDashArray = A), (D = m.nullDataLineDashType))
                                            : (d(), (y = []))),
                                        (r = !0);
                                else {
                                    ...
                                    y[y.length] = { x: g, y: r };
                                    q < p.length - 1 &&
                                        (H !== (p[q].lineColor || z) || D !== (p[q].lineDashType || m.lineDashType)) &&
                                        ((H = p[q].lineColor || z),
                                        (y[y.length - 1].newStrokeStyle = H),
                                        b.setLineDash && (p[q].lineDashType ? ((D = p[q].lineDashType), (y[y.length - 1].newLineDashArray = J(D, m.lineThickness))) : ((D = m.lineDashType), (y[y.length - 1].newLineDashArray = B))));
                                    ...
                                    (p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: m, point: { x: g, y: r }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x });
                                    r = !1;
                                }
                        d();
                        W.drawMarkers(l);
                                ...
                                "number" !== typeof r[s].y
                                    ...
                                    : ((n = a.axisX.convertValueToPixel(y)),
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      (g.options.nullDataLineDashType || (L === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
                                                      ((d = n), (c = u), (n = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (n = d), (u = c), (H = m), (L = g.nullDataLineDashType), f.setLineDash(S)),
                                                  f.lineTo(n, $),
                                                  f.lineTo(n, u),
                                                  w && (l.lineTo(n, $), l.lineTo(n, u)))
                                                : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), (H = { x: n, y: u })),
                                            (c = d = !1))
                                          : (f.lineTo(n, $), w && l.lineTo(n, $), f.lineTo(n, u), w && l.lineTo(n, u), 0 == s % 250 && b()),
                                      (m = { x: n, y: u }),
                                      s < r.length - 1 &&
                                          (A !== (r[s].lineColor || v) || L !== (r[s].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (A = r[s].lineColor || v),
                                          (f.strokeStyle = A),
                                          f.setLineDash && (r[s].lineDashType ? ((L = r[s].lineDashType), f.setLineDash(J(L, g.lineThickness))) : ((L = g.lineDashType), f.setLineDash(B)))),
                                      (y = g.dataPointIds[s]),
                                      (this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: s, x1: n, y1: u }),
                                      0 !== r[s].markerSize &&
                                          (0 < r[s].markerSize || 0 < g.markerSize) &&
                                          (($ = g.getMarkerProperties(s, n, u, f)), h.push($), (y = X(y)), w && h.push({ x: n, y: u, ctx: l, type: $.type, size: $.size, color: y, borderColor: y, borderThickness: $.borderThickness })),
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !$))))
                                if ("number" !== typeof ga.y) D.connectNullData || $ || y || d(), ($ = !0);
                                    ...
                                    y || $
                                        ? (!y && D.connectNullData
                                              ? (b.setLineDash &&
                                                    (D.options.nullDataLineDashType || (x === D.lineDashType && D.lineDashType !== D.nullDataLineDashType)) &&
                                                    ((y = k.pop()), (x = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), (x = D.nullDataLineDashType), b.setLineDash(S)),
                                                b.lineTo(g, r),
                                                w && n.lineTo(g, r))
                                              : (b.beginPath(), b.moveTo(g, r), w && (n.beginPath(), n.moveTo(g, r))),
                                          ($ = y = !1))
                                        : (b.lineTo(g, r), w && n.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && n.moveTo(g, r), k.push({ x: g, y: s - na })));
                                    u = { x: g, y: r };
                                    q < v.length - 1 &&
                                        (L !== (v[q].lineColor || A) || x !== (v[q].lineDashType || D.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, r),
                                        k.push({ x: g, y: s - na }),
                                        (L = v[q].lineColor || A),
                                        (b.strokeStyle = L),
                                        b.setLineDash && (v[q].lineDashType ? ((x = v[q].lineDashType), b.setLineDash(J(x, D.lineThickness))) : ((x = D.lineDashType), b.setLineDash(B))));
                                    ...
                                    0 <= D.dataPointIndexes[f] &&
                                        ...
                                        ((na = D.getMarkerProperties(D.dataPointIndexes[f], g, r, b)),
                                        l.push(na),
                                        (f = X(ka)),
                                        w && l.push({ x: g, y: r, ctx: n, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness }));
                                    (ga.indexLabel || D.indexLabel || ga.indexLabelFormatter || D.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: ga, dataSeries: D, point: { x: g, y: r }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, r);
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !$))))
                                if ("number" !== typeof ga.y) D.connectNullData || $ || n || d(), ($ = !0);
                                    ...
                                    n || $
                                        ? (!n && D.connectNullData
                                              ? (b.setLineDash &&
                                                    (D.options.nullDataLineDashType || (u === D.lineDashType && D.lineDashType !== D.nullDataLineDashType)) &&
                                                    ((n = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(s.x, s.y), k.push(u), k.push(n), (u = D.nullDataLineDashType), b.setLineDash(S)),
                                                b.lineTo(g, r),
                                                w && x.lineTo(g, r))
                                              : (b.beginPath(), b.moveTo(g, r), w && (x.beginPath(), x.moveTo(g, r))),
                                          ($ = n = !1))
                                        : (b.lineTo(g, r), w && x.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && x.moveTo(g, r), k.push({ x: g, y: y - ka })));
                                    s = { x: g, y: r };
                                    q < v.length - 1 &&
                                        (L !== (v[q].lineColor || A) || u !== (v[q].lineDashType || D.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, r),
                                        k.push({ x: g, y: y - ka }),
                                        (L = v[q].lineColor || A),
                                        (b.strokeStyle = L),
                                        b.setLineDash && (v[q].lineDashType ? ((u = v[q].lineDashType), b.setLineDash(J(u, D.lineThickness))) : ((u = D.lineDashType), b.setLineDash(B))));
                                    if (0 <= D.dataPointIndexes[f]) {
                                    ...
                                    0 <= D.dataPointIndexes[f] &&
                                        0 !== ga.markerSize &&
                                        (0 < ga.markerSize || 0 < D.markerSize) &&
                                        ((ka = D.getMarkerProperties(q, g, r, b)), t.push(ka), (f = X(F)), w && t.push({ x: g, y: r, ctx: x, type: ka.type, size: ka.size, color: f, borderColor: f, borderThickness: ka.borderThickness }));
                                    (ga.indexLabel || D.indexLabel || ga.indexLabelFormatter || D.indexLabelFormatter) &&
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (((f = m[e].getTime ? (f = m[e].x.getTime()) : (f = m[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y)) {
                                ...
                                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ...
                                    (p = X(p)),
                                    w && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
                        ...
                        for (var x = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (
                                ...
                                var z = (h - r / 2) << 0,
                                    ...
                                    v = 0 === D % 2 ? 0 : 0.5,
                                    A = u.dataPointIds[t];
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: ba, dataPointIndex: t, x1: z, y1: k, x2: H, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: D, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = D;
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(h - v, m),
                                      ...
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                                      Y(c, z, Math.min(k, q), H, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, D, e, x, x, !1, !1, u.fillOpacity),
                                      w &&
                                          ((e = X(A)),
                                          (b.strokeStyle = e),
                                          b.moveTo(h - v, m),
                                          ...
                                          b.lineTo(h - v, p),
                                          b.stroke(),
                                          Y(b, z, Math.min(k, q), H, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === u.type &&
                                      (c.moveTo(h - v, m),
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                    ...
                    if (0 < x.length)
                        for (var z = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (
                                ...
                                c.save();
                                0 < ka &&
                                    (c.beginPath(), (c.strokeStyle = na), (c.lineWidth = ka), c.setLineDash && c.setLineDash(J(E, ka)), c.moveTo(t - F, k), c.lineTo(t - F, h), c.stroke(), c.moveTo(t - F, p), c.lineTo(t - F, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(A, 4);
                                c.beginPath();
                                Y(c, v, Math.min(q, k), D, Math.max(k, q), Q, 0, e, n ? z : !1, n ? !1 : z, !1, !1, ta);
                                c.beginPath();
                                Y(c, v, Math.min(m, q), D, Math.max(q, m), P, 0, e, n ? !1 : z, n ? z : !1, !1, !1, ta);
                                c.beginPath();
                                c.lineWidth = A;
                                c.strokeStyle = e;
                                ...
                                w &&
                                    ...
                                    (b.strokeStyle = e),
                                    (b.lineWidth = ka),
                                    0 < ka && (b.moveTo(t - B - F, k), b.lineTo(t - B - F, Math.max(h, p)), b.stroke(), b.moveTo(t - B - F, Math.min(h, p)), b.lineTo(t - B - F, m), b.stroke()),
                                    Y(b, v, Math.max(k, m), D, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                    0 < S && (b.beginPath(), (b.lineWidth = S), b.moveTo(t + $ / 2, p - ga), b.lineTo(t - $ / 2, p - ga), b.stroke(), b.moveTo(t + $ / 2, h + ga), b.lineTo(t - $ / 2, h + ga), b.stroke()));
                    ...
                    if (0 < g.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                ...
                                u = q.dataPointIds[f];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: n, y1: l, x2: ba, y2: t };
        ...
        n.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var ba = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || (this.data[u].type.match(/(stacked)/gi) && ba) || ba++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y],
                        z = this.data[x],
                        v = z.dataPoints,
                        D = s(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/gi) && z._linkedSeries.visible ? !0 : !1,
                        A = 0;
                    if (D)
                    ...
                    f &&
                        (t = this.options.dataPointMaxWidth
                            ...
                            ? this.dataPointWidth
                            : b
                            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (D ? ba : 1))) << 0
                            : 0.03 * this.width);
                        ...
                        for (var E = z._colorSet, t = 0; t < v.length; t++) {
                            var e = (z.lineColor = z.options.color ? z.options.color : E[0]),
                                L = {
                                    ...
                                    length: s(v[t].whiskerLength) ? (s(z.options.whiskerLength) ? u : z.options.whiskerLength) : v[t].whiskerLength,
                            ...
                            var S = {
                                ...
                                thickness: v[t].stemThickness ? v[t].stemThickness : z.stemThickness,
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(v[t].y) && v[t].y.length && "number" === typeof v[t].y[0] && "number" === typeof v[t].y[1]) {
                                ...
                                b ? (p = ea) : (g = ea);
                                b
                                    ? ((q = a.axisX.reversed ? (k + ((D ? ba : 1) * u) / 2 - (D ? A - 1 : 0) * u) << 0 : (k - ((D ? ba : 1) * u) / 2 + (D ? A - 1 : 0) * u) << 0), (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                                    : ((m = a.axisX.reversed ? (h + ((D ? ba : 1) * u) / 2 - (D ? A - 1 : 0) * u) << 0 : (h - ((D ? ba : 1) * u) / 2 + (D ? A - 1 : 0) * u) << 0), (p = a.axisX.reversed ? (m - u) << 0 : (m + u) << 0));
                                !b && q > g && ((ea = q), (q = g), (g = ea));
                                b && m > p && ((ea = m), (m = p), (p = ea));
                                ea = z.dataPointIds[t];
                                ...
                                if (v[t].indexLabel || z.indexLabel || v[t].indexLabelFormatter || z.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: z,
                                            indexKeyword: 1,
                                            point: { x: b ? (v[t].y[1] >= v[t].y[0] ? p : m) : m + (p - m) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? q : g },
                                            direction: v[t].y[1] >= v[t].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                            ...
                            if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !L)))))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || L
                                        ? (m.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    (m.options.nullDataLineDashType || (D === m.lineDashType && m.lineDashType !== m.nullDataLineDashType)) &&
                                                    ((h[h.length - 1].newLineDashArray = E), (D = m.nullDataLineDashType), b.setLineDash(B)),
                                                b.lineTo(r, s),
                                                w && e.lineTo(r, s),
                                                h.push({ x: r, y1: s, y2: n }))
                                              : (b.beginPath(), b.moveTo(r, s), (y = { x: r, y: s }), (h = []), h.push({ x: r, y1: s, y2: n }), w && (e.beginPath(), e.moveTo(r, s))),
                                          (L = q = !1))
                                        : (b.lineTo(r, s), h.push({ x: r, y1: s, y2: n }), w && e.lineTo(r, s), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: s, y2: n };
                                    g < p.length - 1 &&
                                        (A !== (p[g].lineColor || v) || D !== (p[g].lineDashType || m.lineDashType)) &&
                                        (d(),
                                        (A = p[g].lineColor || v),
                                        ...
                                        b.setLineDash &&
                                            (p[g].lineDashType
                                                ? ((D = p[g].lineDashType), (h[h.length - 1].newLineDashArray = J(D, m.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                                                : ((D = m.lineDashType), (h[h.length - 1].newLineDashArray = E), b.setLineDash(E))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < m.markerSize)) {
                                        var S = m.getMarkerProperties(g, r, n, b);
                                        f.push(S);
                                        var ea = X(u);
                                        w && f.push({ x: r, y: n, ctx: e, type: S.type, size: S.size, color: ea, borderColor: ea, borderThickness: S.borderThickness });
                                        S = m.getMarkerProperties(g, r, s, b);
                                        f.push(S);
                                        ea = X(u);
                                        w && f.push({ x: r, y: s, ctx: e, type: S.type, size: S.size, color: ea, borderColor: ea, borderThickness: S.borderThickness });
                                    }
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: r, y: s }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: x }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: p[g],
                                                dataSeries: m,
                        ...
                        for (g = !1; p < m.length; p++)
                            if (((q = m[p].x.getTime ? m[p].x.getTime() : m[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: p, x1: q, y1: g, y2: r };
                                    n[n.length] = { x: q, y: g };
                                    ba[ba.length] = { x: q, y: r };
                                    p < m.length - 1 &&
                                        (x !== (m[p].lineColor || y) || z !== (m[p].lineDashType || k.lineDashType)) &&
                                        ((x = m[p].lineColor || y),
                                        (n[n.length - 1].newStrokeStyle = x),
                                        b.setLineDash && (m[p].lineDashType ? ((z = m[p].lineDashType), (n[n.length - 1].newLineDashArray = J(z, k.lineThickness))) : ((z = k.lineDashType), (n[n.length - 1].newLineDashArray = A))));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        f.push(G);
                                        L = X(B);
                                        w && f.push({ x: q, y: r, ctx: e, type: G.type, size: G.size, color: L, borderColor: L, borderThickness: G.borderThickness });
                                    }
                                    ...
                                    0 < p &&
                                        !g &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && ((n[n.length - 1].newLineDashArray = D), (z = k.nullDataLineDashType))
                                            : (d(A, y), (n = []), (ba = []))),
                                        (g = !0);
                        d(A, y);
                        W.drawMarkers(f);
                    ...
                    if (0 < v.length)
                        for (var x = 5 < q && n.bevelEnabled ? !0 : !1, z = !1, A = null, D = null, l = 0; l < v.length; l++)
                            if ((v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), "number" !== typeof v[l].y)) {
                                ...
                                e = n.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: l, x1: h, y1: s, x2: E, y2: k };
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(L, S - y),
                                    0 < u && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(A, D - y), b.lineTo(L, S - y), 0 < u && b.stroke()));
                                z = !1;
                                A = E;
                                D = 0 < v[l].y ? s : k;
        ...
        var pa = function (a, d, c, b, e, f, l, h, s) {
            if (!(0 > c)) {
                ...
                "pie" === e
                    ...
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= s && a.arc(d.x, d.y, s * c, l, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
        n.prototype.renderPie = function (a) {
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        pa(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius);
                    }
                }
                a = n.plotArea.ctx;
                a.save();
                    ...
                    0 > c
                        ? ((h = "right" === p.hemisphere ? t : q),
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((l = -t), (h = f(h, l, d + 1)), +h.toFixed(y) > +l.toFixed(y) && (k = c > r ? -(c - r) : -(t - (h - l))))))
                        : 0 < c &&
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((l = t), (h = f(h, l, d + 1)), +h.toFixed(y) < +l.toFixed(y) && (k = c > r ? c - r : t - (l - h)))));
                    k &&
                            ...
                            if (null !== u) {
                                ...
                                if (0 > z) {
                                    ...
                                    var A = -1 * (z - s),
                                        J = (H = 0);
                                    "right" === h.hemisphere
                                        ? ((H = f(a, s)), (A = -1 * (z - H)), (J = f(u, A)), +J.toFixed(y) < +A.toFixed(y) && +H.toFixed(y) <= +s.toFixed(y) && f(a, -(A - J)))
                                        : ((H = f(u, s)), (A = -1 * (z - H)), (J = f(a, A)), +J.toFixed(y) < +A.toFixed(y) && +H.toFixed(y) <= +s.toFixed(y) && f(u, -(A - J)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++)
                            (h = g[a]), (w = "pie" === k.type ? 0.7 * D : 0.85 * D), (u = x.x + w * Math.cos(h.midAngle)), (s = x.y + w * Math.sin(h.midAngle)), (h.indexLabelTextBlock.x = u), (h.indexLabelTextBlock.y = s);
                    for (a = 0; a < m.length; a++)
                        if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
                            (u = u = 0),
                                ...
                                0 < u &&
                                    ...
                                    Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < D || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) < D) &&
                                ...
                                0 < u &&
                                    ...
                                    Math.abs(h.indexLabelTextBlock.x - x.x) < D && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== z) {
                    ...
                    var B = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ta(k.innerRadius, D) : 0.7 * D;
                    k.radius = D;
        ...
        n.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var k = (d[0] = 0), h = 0, m, p, b = b - a, k = !1, l = 0; l < y.length; l++)
                    (a = (Math.abs(y[l].y) * f) / g),
                        k
                            ? (m = 0 == Number(c.toFixed(3)) ? 0 : a / c)
                            : ((p = aa * aa * b * b - 4 * Math.abs(aa) * a),
                              0 > p
                                  ? ((p = c), (k = ((b + p) * (e - h)) / 2), (a -= k), (m = e - h), (h += e - h), (m += 0 == p ? 0 : a / p), (h += a / p), (k = !0))
                                  : ((m = (Math.abs(aa) * b - Math.sqrt(p)) / 2),
                                    (p = b - (2 * m) / Math.abs(aa)),
                                    (h += m),
                                    h > e && ((h -= m), (p = c), (k = ((b + p) * (e - h)) / 2), (a -= k), (m = e - h), (h += e - h), (m += a / p), (h += a / p), (k = !0)),
                                    (b = p))),
                        d.push(m);
                return d;
            }
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, l, k, h, m, p, q, t, n, r, C = [], x = [], v = { percent: null, total: null }, z = null, D = 0; D < y.length; D++)
                        (r = R[D]), (r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2), (r = g(r).x2 + 1), (C[D] = K - r - X);
                    r = 0.5 * X;
                    for (var D = 0, B = y.length - 1; D < y.length || 0 <= B; D++, B--) {
                        b = u.reversed ? y[B] : y[D];
                        a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - D) % u._colorSet.length] : u._colorSet[D % u._colorSet.length];
                        ...
                        t = u.dataPointIds[D];
                        A._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataPointIndex: D, dataSeriesIndex: 0, funnelSection: R[u.reversed ? y.length - 1 - D : D] };
                        "inside" === u.indexLabelPlacement &&
                            ((C[D] = D !== ca ? (u.reversed ? R[D].x2 - R[D].x1 : R[D].x3 - R[D].x4) : R[D].x3 - R[D].x6),
                            20 > C[D] && ((C[D] = D !== ca ? (u.reversed ? R[D].x3 - R[D].x4 : R[D].x2 - R[D].x1) : R[D].x2 - R[D].x1), (C[D] /= 2)));
                ...
                if (e)
                    for (k = I.length - 1; 0 <= k; k--)
                        (a = R[k]),
                            ...
                            (I[k].textBlock.x = K - l),
                            (c = I[k].textBlock.height < I[k].textBlock.maxHeight ? I[k].textBlock.height : I[k].textBlock.maxHeight),
                            (e = I[k].textBlock.width < I[k].textBlock.maxWidth ? I[k].textBlock.width : I[k].textBlock.maxWidth),
                            (I[k].height = c),
                            (I[k].width = e),
                            (c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2),
                            (I[k].textBlock.y = c - I[k].height / 2),
                            u.reversed
                                ? (I[k].textBlock.y + I[k].height > U + z && (I[k].textBlock.y = U + z - I[k].height), I[k].textBlock.y < ta - z && (I[k].textBlock.y = ta - z))
                                : (I[k].textBlock.y < U - z && (I[k].textBlock.y = U - z), I[k].textBlock.y + I[k].height > ta + z && (I[k].textBlock.y = ta + z - I[k].height));
            }
            function f() {
                var a, b, c, d;
                    ...
                    for (var e = 0; e < R.length; e++)
                        0 == I[e].textBlock.text.length
                            ...
                            : ((a = R[e]),
                              ...
                              u.reversed
                                  ? (I[e].textBlock.y + I[e].height > U + z && (I[e].textBlock.y = U + z - I[e].height), I[e].textBlock.y < ta - z && (I[e].textBlock.y = ta - z))
                                  : (I[e].textBlock.y < U - z && (I[e].textBlock.y = U - z), I[e].textBlock.y + I[e].height > ta + z && (I[e].textBlock.y = ta + z - I[e].height)));
                else
            ...
            function l() {
                ...
                for (var d, e, f, g, l, k, m = 1, r = 0; r < 2 * m; r++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && l && e + d + da > +k.y.toFixed(6) && ((d = g.y + d + da - k.y), (e = a(n, -d)), e < d && (0 < e && (d -= e), (e = a(q(n), d)), e != d)));
                        n--
                    );
                    b();
                }
            ...
            function h(a, b) {
                return (b < R.length ? I[b].textBlock.y : u.reversed ? U + z : ta + z) - (0 > a ? (u.reversed ? ta - z : U - z) : I[a].textBlock.y + I[a].height + da);
            }
            function n(a, b, c) {
                var d,
                    e,
            ...
            function m(a) {
                for (var b, c, d, e, f = 0; f < R.length; f++)
                    (e = 1 === I[f].lineThickness % 2 ? 0.5 : 0),
                        ...
                        I[f].isDirty ||
                            0 == I[f].lineThickness ||
                            ((a.strokeStyle = I[f].lineColor), (a.lineWidth = I[f].lineThickness), a.setLineDash && a.setLineDash(J(I[f].lineDashType, I[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
            }
            function p(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, D = 0, E = x.height - 2 * z, G = Math.min(x.width - 2 * B, 2.8 * x.height), L = !1, S = 0;
                    S < y.length;
                    S++
                )
                    if (
                        (!L && "undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel && 0 < y[S].indexLabel.toString().length && (L = !0),
                        !L && "undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length && (L = !0),
                        (!L && "function" === typeof u.indexLabelFormatter) || "function" === typeof y[S].indexLabelFormatter)
                    )
                        L = !0;
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
                    ...
                    "funnel" === u.type
                        ? ((Q = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
                          ...
                          "string" === typeof Q && Q.match(/%$/) ? ((Q = parseInt(Q)), (Q = (Q * E) / 100)) : (Q = parseInt(Q)),
                          "string" === typeof F && F.match(/%$/) ? ((F = parseInt(F)), (F = (F * a) / 100)) : (F = parseInt(F)),
                          Q > E ? (Q = E) : 0 >= Q && (Q = 0),
                          F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
                        : "pyramid" === u.type && ((F = Q = 0), (u.reversed = u.reversed ? !1 : !0));
                    var B = S + a / 2,
                        T = S,
                        V = S + a,
                        U = u.reversed ? N : $,
                    ...
                    if (-1 !== S) {
                        if (u.reversed) for (G.push(Y), F = S.length - 1; 0 < F; F--) (Y += S[F]), G.push(Y);
                        else for (F = 0; F < S.length; F++) (Y += S[F]), G.push(Y);
                        if (u.reversed) for (F = 0; F < S.length; F++) G[F] < Ca ? (a.push(O), B.push(W), (ca = F)) : (a.push((G[F] - U + aa * T) / aa), B.push((G[F] - U + fa * V) / fa));
                        else for (F = 0; F < S.length; F++) G[F] < Ca ? (a.push((G[F] - U + aa * T) / aa), B.push((G[F] - U + fa * V) / fa), (ca = F)) : (a.push(O), B.push(W));
                        for (F = 0; F < S.length - 1; F++)
                            (Y = u.reversed ? (y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length]) : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length]),
                                F === ca
                                    ? R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: W, y3: Ca, x4: B[F + 1], y4: G[F + 1], x5: a[F + 1], y5: G[F + 1], x6: O, y6: Ca, id: F, height: G[F + 1] - G[F], color: Y })
                                    : R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: B[F + 1], y3: G[F + 1], x4: a[F + 1], y4: G[F + 1], id: F, height: G[F + 1] - G[F], color: Y });
                        var da = 2,
                            I = [],
                            ha = !1,
                            Z = [],
                        ...
                        if (!L)
                            for (F = 0; F < y.length; F++)
                                (D = u.dataPointIds[F]), (a = { id: D, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[u.reversed ? y.length - 1 - F : F] }), (A._eventManager.objectMap[D] = a);
        ...
        n.prototype.print = function () {
            ...
            V(d, { position: "absolute", width: "100%", border: "0px", margin: "0px 0px 0px 0px", padding: "0px 0px 0px 0px" });
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                return "x" === a
                    ? ((c.axisX && "dateTime" === c.axisX.valueType) || "dateTime" === c.xValueType || (d.x && d.x.getTime)) && !c.axisX.logarithmic
                        ...
                        : da(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : (c.xValueFormatString = "#,##0.########"), f._cultureInfo)
                    : "y" === a
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            (q.textBlock = new ja(this.ctx, {
                                ...
                                (this.height += q.textBlock.height ? q.textBlock.height : this.lineHeight);
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "bubble":
                                w = q.size;
                                r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                r <= w / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }), (h = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                w = q.center;
                                ...
                                r < q.radius &&
                                    ...
                                    w >= v && 0 !== g.y && !s(g.y) && ((v += 360), r < w && (r += 360)),
                                    r > w && r < v && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = q.funnelSection;
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    (l = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
                        (A = s(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                for (d = 0; d < this._stripLineLabels.length; d++)
                    "outside" === this._stripLineLabels[d].stripLine.labelPlacement &&
                        ...
                        a < f && (a = f),
                        (this.stripLineLabelEffectiveWidth = this._stripLineLabels[d].effectiveWidth = f));
            }
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)
                    "outside" === this._stripLineLabels[c].stripLine.labelPlacement &&
                        ...
                        "inside" === this.labelPlacement && (a += 0 < this._index ? f : 0),
                        a < f && (a = f),
                        (this.stripLineLabelEffectiveHeight = this._stripLineLabels[c].effectiveHeight = f));
            }
        ...
        A.setLayout = function (a, d, c, b, e, f) {
            ...
            for (var v = (w = 0), u = 0, y = 0, x = 0, z = 0, A = 0, D, B, E = (h = 0), G, J, K, r = (G = J = K = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], M = [], Q = [], N = [], P = []; 4 > w; ) {
                    var F = 0,
                        ...
                        R = 0,
                        aa = 0;
                    if (c && 0 < c.length) for (z = [], g = R = 0; g < c.length; g++) z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (R += z[g]), (O += c[g] && !m.isNavigator ? c[g].margin : 0);
                    else z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    N.push(z);
                    if (b && 0 < b.length) for (A = [], g = aa = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), (aa += A[g]), (Z += b[g] ? b[g].margin : 0);
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                !a[g] ||
                                    ...
                                    ((h = 0),
                                    0 < a[g].labelAngle
                                        ? B + u > n && (h += 0 < a[g].labelAngle ? B + u - n - aa : 0)
                                        : 0 > a[g].labelAngle
                                        ? D - v < l && D - v < a[g].viewportMinimum && (E = l - (O + a[g].tickLength + z + D - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (B + u > n && (h = B + u / 2 - n - aa), D - v < l && D - v < a[g].viewportMinimum && (E = l - O - a[g].tickLength - z - D + v / 2)),
                                    a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h
                                        ...
                                        ? (l += E)
                                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (n -= h))),
                                m.panEnabled ? (W = s(m.sessionVariables.axisX.height) ? (m.sessionVariables.axisX.height = W) : m.sessionVariables.axisX.height) : (m.sessionVariables.axisX.height = W),
                                ...
                                "inside" === a[g].labelPlacement &&
                                    0 < g &&
                                    ((a[g].lineCoordinates.y1 = a[g - 1].lineCoordinates.y2 + F + (a[g].labelEffectiveHeight || 0)), (a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2)),
                                ...
                                (a[g].bounds = { x1: l, y1: h, x2: n, y2: k - (W + e - y[g] - F), width: n - l }),
                                (a[g].bounds.height = a[g].bounds.y2 - a[g].bounds.y1)),
                                (F += y[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + R + O)),
                                (d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - Z > m.width - p ? m.width - p : f.x2 - aa - Z)),
                                (d[g].lineCoordinates.width = Math.abs(n - l)),
                                d[g]._labels &&
                                    ...
                                    (v = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                                m.panEnabled ? (Y = s(m.sessionVariables.axisX2.height) ? (m.sessionVariables.axisX2.height = Y) : m.sessionVariables.axisX2.height) : (m.sessionVariables.axisX2.height = Y),
                                (h = Math.round(f.y1)),
                                (k = d[g].lineCoordinates.y1 = h + Y + V - X),
                                (d[g].lineCoordinates.y2 = h),
                                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].lineCoordinates.y1 - X - (d[g].labelEffectiveHeight || 0)),
                                "inside" === d[g].tickPlacement && 0 < g && (d[g].lineCoordinates.y1 -= d[g].tickLength),
                                (d[g].bounds = { x1: l, y1: h + (Y + V - x[g] - X), x2: n, y2: k, width: n - l }),
                        ...
                        for (g = 0; g < c.length; g++)
                            (O = m.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (O = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p),
                                    (h = Math.round(f.y1 + Y + V < Math.max(O, p) ? Math.max(O, p) : f.y1 + Y + V)),
                                    (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                    (O = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p),
                                    (k = Math.round(f.y2 - W - e - O)),
                                    (c[g].lineCoordinates = { x1: l - T, y1: h, x2: n - T, y2: k, height: Math.abs(k - h) }),
                                    "inside" === c[g].labelPlacement &&
                                        0 < g &&
                                        ((c[g].lineCoordinates.x1 = c[g - 1].lineCoordinates.x1 - T - (c[g].labelEffectiveWidth || 0)), (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                                    ...
                                    (c[g].bounds = { x1: l - (z[g] + T), y1: h, x2: n - T, y2: k, height: k - h }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (k = Math.round(f.y2 - (W + e + O))),
                                (b[g].lineCoordinates = { x1: l + U, y1: h, x2: l + U, y2: k, height: Math.abs(k - h) }),
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.x1 = b[g - 1].lineCoordinates.x2 + U + (b[g].labelEffectiveWidth || 0)), (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                                ...
                                (b[g].bounds = { x1: l + U, y1: h, x2: n + (A[g] + U), y2: k, height: k - h }),
                    ...
                    if (0 < w) {
                        ...
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) G = Q[w - 1][g] === Q[w][g] ? !0 : !1;
                        else G = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else K = !0;
                    }
                    if (r && G && J && K) break;
                    w++;
                ...
                for (Q = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length) for (E = [], g = U = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (U += E[g]), (e += a[g] && !m.isNavigator ? a[g].margin : 0);
                    else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(E);
                    if (d && 0 < d.length) for (v = [], g = W = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (W += v[g]), (V += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                (n = Math.round(f.x2 - W - V > m.width - 10 ? m.width - 10 : f.x2 - W - V)),
                                c[g].labelAutoFit &&
                                    !s(y) &&
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + U + e)),
                                (n = Math.round(f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V)),
                                b[g] && b[g].labelAutoFit && !s(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (n -= A / 2)),
                    ...
                    if (c && 0 < c.length) for (p = [], g = T = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (T += p[g] + c[g].margin), (O += c[g].margin);
                    else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    B.push(p);
                    if (b && 0 < b.length) for (D = [], g = 0; g < b.length; g++) D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (Z += b[g].margin);
                    ...
                    if (m.panEnabled) for (g = 0; g < c.length; g++) p[g] = s(m.sessionVariables.axisY[g].height) ? (m.sessionVariables.axisY[g].height = p[g]) : m.sessionVariables.axisY[g].height;
                    else for (g = 0; g < c.length; g++) m.sessionVariables.axisY[g].height = p[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (h = Math.round(f.y2)),
                                ...
                                "inside" === c[g].labelPlacement &&
                                    0 < g &&
                                    ((c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - c[g].tickLength - (c[g].stripLineLabelEffectiveHeight || 0) - 5),
                                ...
                                (c[g].bounds = { x1: l, y1: h - (p[g] + Y + c[g].margin), x2: n, y2: k - (Y + c[g].margin), width: n - l, height: p[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (Y += p[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.y1 = k - D[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength + (b[g].stripLineLabelEffectiveHeight || 0)),
                                ...
                                (b[g].bounds = { x1: l, y1: h + (b[g].margin + F), x2: n, y2: k, width: n - l }),
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(O, 10) ? m.height - Math.max(O, 10) : f.y2 - T)
                            ...
                            "inside" === a[g].labelPlacement &&
                                0 < g &&
                                ((a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + a[g].tickLength + (a[g].stripLineLabelEffectiveWidth || 0)),
                        ...
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (O = 0; O < c.length; O++)
                                    c[O] && c[O].labelAutoFit && ((n = 0 > c[O].labelAngle ? Math.max(n, y) : 0 === c[O].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[O].labelAngle || 0 === c[O].labelAngle ? n - W : l));
                            ...
                            "inside" === d[g].labelPlacement &&
                                0 < g &&
                                ((d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - d[g].tickLength - (d[g].stripLineLabelEffectiveWidth || 0)),
                            ...
                            (c.textBlock.angle = -90),
                                "bottom" === this._position
                                    ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.height - 3),
                                      ...
                                      a.x - c.textBlock.height - k.thickness / 2 > this.chart.plotArea.x1
                                          ? s(k.startValue)
                                              ? (a.x -= c.textBlock.height - c.textBlock.fontSize / 2 + k.thickness / 2)
                                              : (a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2)
                                          : ((c.textBlock.angle = 90), s(k.startValue) ? (a.x += c.textBlock.height - c.textBlock.fontSize / 2 + k.thickness / 2) : (a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2)),
                                      (a.y =
                                    ...
                                    ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.width - 3),
                                      (c.textBlock.angle = 0),
                                      c.textBlock.measureText(),
                                      a.y - c.textBlock.height - k.thickness / 2 > this.chart.plotArea.y1
                                          ? s(k.startValue)
                                              ? (a.y -= c.textBlock.height - c.textBlock.fontSize / 2 + k.thickness / 2)
                                              : (a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2)
                                          : s(k.startValue)
                                          ? (a.y += c.textBlock.height - c.textBlock.fontSize / 2 + k.thickness / 2)
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType ||
                        (b / 1 <= a
                            ...
                            : ((this.interval = b / (1 * T.yearDuration) <= a ? 1 : b / (2 * T.yearDuration) <= a ? 2 : b / (4 * T.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / T.yearDuration)),
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var B = 0; B < this.parent.dataSeries.length; B++)
                        (v = this.parent.dataSeries[B].getDataPointAtX(r, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[B]), null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (var y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = (u = 0), r = (B = 0); r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = (x = u = 0), r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                            else
                                (x += m[r].dataPoint.y),
                                    (z = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x),
                                    (z = 100 * (x / m[r].dataSeries.plotUnit.dataPointYSums[z])),
                                    (u = Math.abs(a - this.parent.convertValueToPixel(z))),
                                    u < v && ((v = u), (B = r));
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = B = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y))), u < v && ((v = u), (B = r));
                    y = m[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            k.text = this.labelFormatter
                                ...
                                ? da(s(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            k.text = this.labelFormatter
                                ...
                                : s(this.options.label)
                                ? da(s(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            k.text = this.labelFormatter
                                ...
                                : s(this.options.label)
                                ? da(s(c) ? z : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                        } else
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                    ...
                    if (z) {
                        if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({ x: a }), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                (v = this.parent.dataSeries[B].getDataPointAtX(r, !0)) &&
                                    0 <= v.index &&
                                    (k.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = x = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (B = r));
                        ...
                        "waterfall" === this.parent.dataSeries[B].type
                            ? ((w =
                              ...
                              (k.text = this.labelFormatter
                                  ...
                                  : s(this.options.label)
                                  ? da(s(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                            ...
                            : ((w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? y.dataPoint.y : c })
                                  : s(this.options.label)
                                  ? da(s(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataPoint.y));
                        ...
                        if (z) {
                            ...
                            k.text =
                                "dateTime" !== this.parent.valueType || this.parent.logarithmic
                                    ...
                                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(d) : c })
                                    : s(this.options.label)
                                    ? Ba(s(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                                    : this.label;
                    ...
                    if (z) {
                        ...
                        k.text =
                            "dateTime" !== this.parent.valueType || this.parent.logarithmic
                                ...
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(a) : c })
                                : s(this.options.label)
                                ? Ba(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                    k.x = b - k.measureText().width / 2;
                    k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
                    k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
                    ...
                    !1 === f.highlightEnabled ||
                        ...
                        "rangeSplineArea" === b.type
                            ...
                            : "column" === b.type ||
                              ...
                              "rangeColumn" === b.type ||
                              "waterfall" === b.type
                            ? Y(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3)
                            : "pie" === b.type || "doughnut" === b.type
                            ? pa(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? ((d.globalAlpha = 1),
                              ...
                              d.stroke(),
                              Y(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                              (d.globalAlpha = 1))
                            : "ohlc" === b.type
                            ? ((d.globalAlpha = 1),
                              (d.strokeStyle = e.color),
                            ...
                            ? (d.save(),
                              ...
                              d.restore(),
                              (d.globalAlpha = 1))
                            : "error" === b.type && B(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
                }
            }
            d.restore();
            d.globalAlpha = 1;
