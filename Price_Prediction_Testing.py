...
# Algorithm used for training: Decsion tree regressor

# Call this function PricePrediction to get the predictions from other modules

def PricePrediction(crop_name):
    ...
    max_price, min_price, forecast_values = TwelveMonthsForecast(crop_name) 
    current_price = CurrentMonth(crop_name)
    return max_price, min_price, current_price, forecast_values
...
# max, min, cur, forecast_val = PricePrediction("Bajra")
# print("Maximum predicted price of crop: ", max)
# print("Maximum predicted price of crop: ", min)
# print("Current Price of the crop: ", cur)
# print("Forecasted price of the crop for next 12 months:\n", forecast_val)